...
public:
  ...
  void SetRoomCandidate(bool room_candidate)
  {
    is_room_candidate_ = room_candidate;
  }
  bool RoomCandidate() const
  {
    return is_room_candidate_;
  }
...
private:
  ...
  bool in_collision_;
  // Whether this viewpoint is in the current room
  bool in_room_;
  // Whether this viewpoint is room candidate
  bool is_room_candidate_;
