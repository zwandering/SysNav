...
[.webm](https://github.com/user-attachments/assets/adbbad63-5dcc-4d20-85a5-8f889dff2708)

</td>
<td width="44%">

[.webm](https://github.com/user-attachments/assets/eae1c122-ba3b-47b0-a55e-c1f8f1a9b57f)

</td>
</tr>
<tr>
<td colspan="2" align="center"><em>Find the potted_plant.</em></td>
</tr>
<tr>
<td rowspan="2" align="center"><b>Self-attribute<br>Condition</b></td>
<td>

[.webm](https://github.com/user-attachments/assets/626070a5-ac61-4d6d-b95c-dfb17d4e0a30)

</td>
<td>

[.webm](https://github.com/user-attachments/assets/b01680a3-1a78-49a2-8f89-4e2782f59266)

</td>
</tr>
<tr>
<td colspan="2" align="center"><em>Find the red chair.</em></td>
</tr>
<tr>
<td rowspan="2" align="center"><b>Spatial<br>Condition</b></td>
<td>

[.webm](https://github.com/user-attachments/assets/b074afdf-26dc-47f1-baea-b1d80d73b64f)

</td>
<td>

[.webm](https://github.com/user-attachments/assets/eccf5632-588c-4ac6-8027-0b210daab572)

</td>
</tr>
<tr>
<td colspan="2" align="center"><em>Find the person sitting on the bench/sofa.</em></td>
</tr>
</table>
...
This branch targets the **Unitree Go2** quadruped. For other platforms, switch to the corresponding branch:
- [`main`](https://github.com/zwandering/VLM_ROS) &mdash; wheeled robot + Unity simulation
- [`unitree_g1`](https://github.com/zwandering/VLM_ROS/tree/unitree_g1) &mdash; Unitree G1 humanoid
...
Sensor calibration is handled by the [`360_camera`](https://github.com/jizhang-cmu/360_camera/tree/jazzy) repository (see [360 Camera Driver](#360-camera-driver)).
...
Install [Ubuntu 24.04](https://releases.ubuntu.com/noble) and [ROS2 Jazzy](https://docs.ros.org/en/jazzy/Installation.html) on both the onboard NUC and the desktop workstation:
...
Follow the [Installation](#installation) section on both machines to install all dependencies and compile the full repository.

Configure the WebRTC connection to the Go2 in `src/unitree_webrtc_ros/config/unitree_params.yaml`. By default the system uses `LocalAP` mode at `192.168.12.1` (connecting to the robot's own WiFi access point). Other supported modes are `LocalSTA` (robot on the same LAN &mdash; set `robot_ip` accordingly) and `Remote` (via Unitree cloud).
