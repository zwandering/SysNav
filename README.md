...
This branch targets the **Unitree G1** humanoid. For other platforms, switch to the corresponding branch:
- [`main`](https://github.com/zwandering/VLM_ROS) &mdash; wheeled robot + Unity simulation
- [`unitree_go2`](https://github.com/zwandering/VLM_ROS/tree/unitree_go2) &mdash; Unitree Go2 quadruped
...
./system_real_robot_with_exploration_planner_g1.sh
```
